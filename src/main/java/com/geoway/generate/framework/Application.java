...
import com.geoway.generate.framework.context.SimpleApplicationContext;
import com.geoway.generate.log.LogFactory;
import com.geoway.generate.util.ClassUtils;
import com.geoway.generate.util.DateUtil;
import com.geoway.generate.util.JsonHelper;
...
//            tryCallback(1, callbackUrl, taskHistoryId);
  ...
  private void workWithoutCallback() {
    ...
    logger.info("应用程序{}执行总耗时(秒)：{},总耗时(毫秒):{}", this.applicationName, this.excuteTime,
